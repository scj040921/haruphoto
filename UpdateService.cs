...
public static class UpdateService
{
    ...
    public static async Task<ReleaseInfo?> CheckLatestAsync(CancellationToken cancellationToken = default)
    {
        ...
        if (!Version.TryParse(CurrentVersion, out var localVersion)) return null;
        ...
        foreach (var asset in root.GetProperty("assets").EnumerateArray())
        {
            ...
            if (string.IsNullOrWhiteSpace(url) || string.IsNullOrWhiteSpace(digest)) continue;
